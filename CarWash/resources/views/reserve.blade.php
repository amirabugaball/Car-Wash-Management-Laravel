                        ...
                        <form name="sentMessage" class="well" id="contactForm" method="post" action="">
                            ...
                            <div class="form-group">
                                <div class="controls">
                                    ...
                                    <input type="text" id="apptPrice" class="form-control" placeholder="Price" value="0" name="price" readonly/>
                                </div>
                            </div>
            ...
            success: function (data) {
                ...
                if (len > 0) {
                    for (var x = 0; x < len; x++) {
                        ...
                        console.log(data.appts[x].price);
                        $("#apptPrice").val(data.appts[x].price);
                    }
